...
void MainWindow::on_actionPencil_triggered() {
    this->setCursor(QCursor(QPixmap(":/icons/Pencil-48.png")));
    director->setPencilTool();
}
void MainWindow::on_actionLine_triggered() {
    this->setCursor(QCursor(QPixmap(":/icons/Line-48.png")));
    director->setLineTool();
}
void MainWindow::on_actionRectangle_triggered() {
    this->setCursor(QCursor(QPixmap(":/icons/Rectangle\ Stroked-48.png")));
    director->setRectangleTool();
}
void MainWindow::on_actionFilled_Rectangle_triggered() {
    this->setCursor(QCursor(QPixmap(":/icons/Rectangle-48.png")));
...
void MainWindow::on_actionFilled_Ellipse_triggered() {
    this->setCursor(QCursor(QPixmap(":/icons/Ellipse-48.png")));
